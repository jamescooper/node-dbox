...
exports.app = function (config) {
    ...
    return {
        ...
        authorize: function (options, cb) {
            ...
            var authorize_url = 'https://www.dropbox.com/1/oauth2/authorize?' +  qs.stringify(options);

            return function (e, r, authorize_url) {
                cb(null, authorize_url)
            }
        },

        token: function (options, cb) {
            var body = qs.stringify(options)
            var args = {
                "method": "POST",
                "headers": {
                    "content-type": "application/x-www-form-urlencoded",
            ...
            return request(args, function (e, r, b) {
                function parseData() {
                    return (r.statusCode == 403 && r.headers["content-type"].indexOf("text/html") > -1) ? b : JSON.parse(b);
                }

                cb(e ? null : r.statusCode, parseData())
            })
        },
